...
class users
{
  ...
  //Fetch user email, password and pass to sign_sub.php page
  public function signin($email,$pass)
  {
    ...
    if($query->num_rows>0)
    {
      $_SESSION['email']=$email; //here we store user email to a session variable
      return true;
    }
    else {
      return false;
  ...
  // Ftech Question from database and pass qus_show.php page
  ...
  // display answer of the question
